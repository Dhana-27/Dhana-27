...
![Open to roles](https://img.shields.io/badge/Open%20to%20SWE%20Roles-2025--27-blue?style=flat-square)
![Graduating](https://img.shields.io/badge/B.E.%20CSE%20Cybersecurity-2027-purple?style=flat-square)
...
**SWE Intern — Dpurpose Foundation NGO**
Built tech solutions for social impact. Shipped features under real constraints for an NGO serving underserved communities.

**SWE Intern — Sakthi Veera Group**
Contributed to production full-stack engineering. Gained hands-on experience with scalable systems and team-based development workflows.

---

## 🛠 Tech I actually use

| Languages | Web & Backend | AI / Security | Cloud & DevOps |
|-----------|--------------|---------------|----------------|
| Python, JavaScript, Java | React, Node.js, Django | TensorFlow, PyTorch, OpenCV | AWS, Firebase, Docker |
